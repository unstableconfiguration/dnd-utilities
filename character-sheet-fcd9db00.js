import { _ as _classPrivateMethodInitSpec, b as _classPrivateMethodGet, a as _classPrivateFieldInitSpec, c as _classPrivateFieldGet, L as Lite, G as Gridify } from './index.js';
...
class Character {
  constructor(char) {
    ...
    _classPrivateMethodInitSpec(this, _setSpells);
    // poor naming: 
    // skills = a list of all skills from PH
    // charSkills = params from char sheet 
    _classPrivateMethodInitSpec(this, _setSkills);
    _classPrivateMethodInitSpec(this, _getHp);
    _classPrivateMethodInitSpec(this, _setDefenses);
    _classPrivateMethodInitSpec(this, _setClassLevels);
...
var BarbicanBrady = new Character({
  ...
  // Level 1
  'Comprehend Languages', 'Detect Magic', 'Disguise Self', 'Healing Word', 'Identify',
  // Level 2
  'Enhance Ability'],
  Actions: {
...
var OneTrick = new Character({
  ...
  Spells: [
  // Cantrips
  'Prestidigitation', 'Mending', 'Ray of Frost', 'Message', 'Mage Hand', 'Eldritch Blast', 'Minor Illusion',
  // Level 1
  // Sorcerer
  'Feather Fall', 'Thunderwave',
  // Warlock
  'Hex', 'Protection from Evil and Good', 'Comprehend Languages', 'Detect Magic',
  // Invocation
  // Level 2', 
  // Sorcerer
...
class Stats {
  constructor(options) {
    _classPrivateMethodInitSpec(this, _hideEmpty);
    _classPrivateMethodInitSpec(this, _hide);
    _classPrivateMethodInitSpec(this, _getKeyValueDiv);
    _classPrivateMethodInitSpec(this, _bindKeyValues);
    _classPrivateMethodInitSpec(this, _bindData$4);
    _classPrivateMethodInitSpec(this, _setLevelText);
    _classPrivateMethodInitSpec(this, _setStats);
    _classPrivateMethodInitSpec(this, _setSaveText);
...
function _setLevelText2() {
  ...
  var levelText = [];
  for (var className in classes) levelText.push(classes[className].Name + ' ' + classes[className].Level);
...
function _bindKeyValues2(key, container) {
  ...
  for (var i in data) container.appendChild(_classPrivateMethodGet(this, _getKeyValueDiv, _getKeyValueDiv2).call(this, i, data[i]));
}
    ...
    if (cap) {
      ...
      for (i = 0; i < l; i++) {
        ...
        if (!list.loose) {
          ...
          var hasMultipleLineBreaks = spacers.length > 0 && spacers.some(t => /\n.*\n/.test(t.raw));
...
class Lexer {
  ...
  blockTokens(src) {
    ...
    var _loop = function _loop() {
      if (_this.options.extensions && _this.options.extensions.block && _this.options.extensions.block.some(extTokenizer => {
  ...
  inlineTokens(src) {
    ...
    var _loop2 = function _loop2() {
      ...
      // extensions
      if (_this2.options.extensions && _this2.options.extensions.inline && _this2.options.extensions.inline.some(extTokenizer => {
        if (token = extTokenizer.call({
          lexer: _this2
        }, src, tokens)) {
          src = src.substring(token.raw.length);
...
marked.use = function () {
  ...
  args.forEach(pack => {
    ...
    if (pack.tokenizer) {
      ...
      var _loop4 = function _loop4(_prop) {
...
marked.walkTokens = function (tokens, callback) {
  var values = [];
  var _loop5 = function _loop5(token) {
...
class Background {
  constructor(options) {
    _classPrivateMethodInitSpec(this, _bindData$3);
...
function _bindData2$3() {
  ...
  var markup = '';
  for (var b in this.character.Background) markup += '* **' + b + '**: ' + this.character.Background[b] + ' \n';
...
class Notes {
  constructor(options) {
    _classPrivateMethodInitSpec(this, _bindData$2);
...
class Skills {
  constructor(options) {
    _classPrivateMethodInitSpec(this, _numberSort$1);
    _classPrivateMethodInitSpec(this, _bindData$1);
    _classPrivateMethodInitSpec(this, _getGridData$2);
...
function _getGridData2$2() {
  ...
  for (var name in skills) results.push(skills[name]);
...
class Items {
  constructor(options) {
    _classPrivateMethodInitSpec(this, _coinSort);
    _classPrivateMethodInitSpec(this, _numberSort);
    _classPrivateMethodInitSpec(this, _bindGrid$1);
    _classPrivateMethodInitSpec(this, _bindCarryWeight);
    _classPrivateMethodInitSpec(this, _getGridData$1);
    _classPrivateMethodInitSpec(this, _bindData);
...
class Spells {
  constructor(options) {
    ...
    _classPrivateMethodInitSpec(this, _bindGrid);
    _classPrivateMethodInitSpec(this, _getGridData);
...
class CharacterSheet {
  constructor(options) {
    _classPrivateMethodInitSpec(this, _loadTabs);
    _classPrivateMethodInitSpec(this, _toggleContainer);
    _classPrivateMethodInitSpec(this, _toggleTabs);
