...
var Router = function Router() {
  ...
  */
  ...
  router.__onHashChange = function () {
    var hash = location.hash.slice(1) // Skip #
    .split('?')[0]; // Ignore query 

    var path = router.routes.find(route => {
  ...
  */
  ...
  var escapeSpecialChars = function escapeSpecialChars(path) {
    ['(', ')', '/'].forEach(specialChar => {
  ...
  */
  ...
  var escapeWildCard = function escapeWildCard(path) {
    return path.replace(/{.+}/, '.+');
  };
...
var Lite = function Lite() {
  ...
  Object.defineProperty(_lite, "container", {
    ...
    set: value => {
      ...
      if (!(value instanceof HTMLElement)) {
        throw new Error('Cannot find HTMLElement: ' + value);
      }
  ...
  */
  ...
  _lite.__bindContent = function () {
    if (!_lite.__container || !_lite.__content) {
      return;
    }
  ...
  */
  ...
  _lite.__bindData = function () {
    if (!_lite.__container || !_lite.__content || !_lite.__data) {
      return;
    }
  ...
  _lite.extend = function () {
    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return function () {
      var more_args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
